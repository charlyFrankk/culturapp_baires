...
class MuseosScreen extends StatefulWidget {
  ...
  @override
  State<MuseosScreen> createState() => _MuseosScreenState();
}

class _MuseosScreenState extends State<MuseosScreen> {
  Map<int, bool> expandedState = {};
  Map<int, String?> descriptions = {};

  Future<void> cargarDescripcion(
    int index,
