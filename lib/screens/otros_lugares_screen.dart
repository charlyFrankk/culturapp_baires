...
class OtrosLugaresScreen extends StatefulWidget {
  ...
  @override
  State<OtrosLugaresScreen> createState() => _OtrosLugaresScreenState();
}

class _OtrosLugaresScreenState extends State<OtrosLugaresScreen> {
  ...
  Future<void> loadDescription(
    ...
    String? description = await widget.searchEngineService.getDescription(
      establishment,
      municipality,
    );
    setState(() {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredPlaces =
        widget.places.where((place) {
          ...
          return !(establishment.contains("museo") ||
              establishment.contains("biblioteca") ||
              establishment.contains("cine") ||
              establishment.contains("teatro"));
        }).toList();
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Otros Sitios Culturales'),
        centerTitle: true,
            ...
            Expanded(
              child:
                  filteredPlaces.isEmpty
                      ? const Center(
                        child: Text(
                          "No hay otros sitios culturales cercanos.",
                          style: TextStyle(
                            fontSize: 18,
