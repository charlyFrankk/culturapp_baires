...
class CinesTeatrosScreen extends StatefulWidget {
  ...
  @override
  State<CinesTeatrosScreen> createState() => _CinesTeatrosScreenState();
}

class _CinesTeatrosScreenState extends State<CinesTeatrosScreen> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredPlaces =
        widget.places.where((place) {
          ...
          return establishment.contains("cine") ||
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Teatros y Cines'),
        centerTitle: true,
            ...
            Expanded(
              child:
                  filteredPlaces.isEmpty
                      ? const Center(
                        child: Text(
                          "No hay cines o teatros cercanos.",
                          style: TextStyle(
                            fontSize: 18,
